...
router.post('/',[
    ...
    check('schedule', 'El cronograma es obligatorio').not().optional({ checkFalsy: true, nullable:true }),
    check('date', 'La fecha es obligatoria').isDate().optional({ checkFalsy: true, nullable:true }),
